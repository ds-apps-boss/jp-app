...
class ScreenStart extends StatelessWidget {
  ...
  child: Align(
    ...
    child: Transform.translate(
      offset: const Offset(50, 0), // смещение вправо на 80px
      child: Transform.scale(
        scale: 1.5, // увеличить на 30%
        child: AspectRatio(
          aspectRatio: 1,
          child: DecoratedBox(
            decoration: const BoxDecoration(
              image: DecorationImage(
                image: AssetImage("assets/images/pics/chick_cupcakes_3D.png"),
                fit: BoxFit.cover,
              ),
            ),
          ),
